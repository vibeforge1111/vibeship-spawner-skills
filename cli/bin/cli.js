...
const CONFIG_PATH = (() => { const idx = process.argv.indexOf("--config") !== -1 ? process.argv.indexOf("--config") : process.argv.indexOf("-c"); return idx > -1 && idx + 1 < process.argv.length ? process.argv[idx+1] : null; })();
